...
import com.example.kiumi.adapter.MenuTutorialAdapter
import com.example.kiumi.R
import com.example.kiumi.data.MenuItem
import com.example.kiumi.feature.tutorial.TutorialMainActivity
 ...
 * Use the [BurgerTutorialFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class BurgerTutorialFragment : Fragment() {
...
//        MenuItem("불고기 버거", "₩2,200", "430 Kcal", R.drawable.bulgogi_burger, false),
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_burger_tutorial, container, false)
        ...
        adapter = MenuTutorialAdapter(menuItems, { menuItem ->
            (activity as? TutorialMainActivity)?.showBurgerSelectionPopup(menuItem)
        }, requireContext())
    ...
    companion object {
         ...
         * @return A new instance of fragment BurgerTutorialFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            BurgerTutorialFragment().apply {
