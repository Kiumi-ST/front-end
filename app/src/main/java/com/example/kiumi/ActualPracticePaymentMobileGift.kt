...
class ActualPracticePaymentMobileGift : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<TextView>(R.id.availableText).text = CartManager.getTotalPrice()
        findViewById<TextView>(R.id.orderText).text = CartManager.getTotalPrice()
        ...
        findViewById<Button>(R.id.buttonNextStep).setOnClickListener {
            val intent = Intent(this, ActualPracticePaymentMobileGiftComplete::class.java)
                .apply { putExtra("previous_activity", "실전 연습_모바일 상품권 결제") }
    ...
    private val onBackPressedCallback = object : OnBackPressedCallback(true) {
        override fun handleOnBackPressed() {
            ...
            val params = Bundle().apply {
                ...
                putString("screen_name", "실전 연습_모바일 상품권 결제")
            }
