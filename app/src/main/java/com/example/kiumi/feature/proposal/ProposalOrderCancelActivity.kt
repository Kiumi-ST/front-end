...
class ProposalOrderCancelActivity : PopupActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_proposal_order_cancel)
        ...
        findViewById<Button>(R.id.button_yes).setOnClickListener {
            ...
            val intent = Intent(this@ProposalOrderCancelActivity, ProposalActivity::class.java)
                .apply { putExtra("previous_activity", "개선안_주문 취소") }
