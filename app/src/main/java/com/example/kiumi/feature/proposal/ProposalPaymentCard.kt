...
class ProposalPaymentCard : PopupActivity() {
    ...
    private val navigateRunnable = Runnable {
        val intent = Intent(this, ProposalPickup::class.java).apply { putExtra("previous_activity", "개선안_결제 방법") }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        instructionsTextView.text = Html.fromHtml(getString(R.string.instructions_text2), Html.FROM_HTML_MODE_LEGACY)
    ...
    private val onBackPressedCallback = object : OnBackPressedCallback(true) {
        override fun handleOnBackPressed() {
            ...
            val params = Bundle().apply {
                ...
                putString("screen_name", "개선안_카드 결제")
            }
